        ...
        <div className="container">
          <div className="flex">
            ...
            <ul className="ml-14 flex gap-10.75">
              {navbardata.map((item) => (
                <li
                  className="text-primary after:bg-primary relative text-sm leading-6 font-medium after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:duration-500 after:content-[''] hover:after:w-[26.05px]"
                  key={item.id}
                >
            ...
            <div className="ml-auto flex gap-8">
              ...
              <button className="relative">
                ...
                <div className="w-4 h-4 bg-[#B9A16B] rounded-full flex items-center justify-center text-white text-xs font-bold absolute  -bottom-1.5 -right-0.75">3</div>
              </button>
